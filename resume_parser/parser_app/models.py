...
class Resume(models.Model): 
    ...
    skills        = models.CharField('Skills', max_length=5000, null=True, blank=True)
    company_name  = models.CharField('Company Name', max_length=5000, null=True, blank=True)
    college_name  = models.CharField('College Name', max_length=5000, null=True, blank=True)
    designation   = models.CharField('Designation', max_length=5000, null=True, blank=True)
    ...
    total_experience  = models.CharField('Total Experience (in Years)', max_length=5000, null=True, blank=True)
